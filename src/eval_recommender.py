...
def main() -> int:
    ...
    print(f"\n{'method':<14}{'set':<12}{'n':>4}{'P@1':>8}{'P@3':>8}{'MRR':>8}")
    print("-" * 54)
    results = {}
    for m in methods:
        ...
        results[m] = {"resolved_loo": loo_r, "unresolved": unr_r}
        print(f"{m:<14}{'resolved-LOO':<12}{loo_r['n']:>4}{loo_r['P@1']:>8}{loo_r['P@3']:>8}{loo_r['MRR']:>8}")
        print(f"{'':<14}{'unresolved':<12}{unr_r['n']:>4}{unr_r['P@1']:>8}{unr_r['P@3']:>8}{unr_r['MRR']:>8}")
    # 결과 저장
